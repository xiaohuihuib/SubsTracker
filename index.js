...
<style>
  /* === 全局暗黑模式核心变量与覆盖 === */
  :root {
    --dark-bg-primary: #111827;   /* 深灰/黑背景 (gray-900) */
    --dark-bg-secondary: #1f2937; /* 卡片/容器背景 (gray-800) */
    --dark-border: #374151;       /* 边框颜色 (gray-700) */
    --dark-text-main: #f9fafb;    /* 主要文字 (gray-50) */
    --dark-text-muted: #9ca3af;   /* 次要文字 (gray-400) */
  }
  ...
  html.dark .text-indigo-600 { color: #818cf8 !important; } /* 靛蓝色变亮一点 */
  ...
  html.dark tbody tr.bg-gray-100 { background-color: #374151 !important; } /* 偶数行或禁用行 */
  /* 弹窗与日期选择器 */
  ...
  @media (max-width: 767px) {
    html.dark .responsive-table td:before {
      color: #9ca3af !important; /* 亮灰色 (gray-400)，确保在深色背景下清晰可见 */
      opacity: 1 !important;
    }
    html.dark .responsive-table tr {
      border-color: #374151 !important;
      background-color: #1f2937 !important; /* 确保卡片背景是深色 */
